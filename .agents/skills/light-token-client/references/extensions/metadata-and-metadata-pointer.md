...
Create a Token 2022 mint with MetadataPointer and TokenMetadata extensions. The metadata pointer points to the mint itself, storing metadata on-chain without a separate account.
